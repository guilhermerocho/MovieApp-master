...
public class MainActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<PopularMain> call, Response<PopularMain> response) {
                if(response.isSuccess()){
                    if(response.body().getResults().size() != 0 &&
                        ...
                        Toast.makeText(MainActivity.this, "no data available 1", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(MainActivity.this, "no data available 2", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<PopularMain> call, Throwable t) {
                Toast.makeText(MainActivity.this, "no data available 3", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void LoadMoreData() {
        ...
        getPopularMovies.enqueue(new Callback<PopularMain>() {
            ...
            public void onResponse(Call<PopularMain> call, Response<PopularMain> response) {
                ...
                if(response.isSuccess()){
                    if(response.body().getResults().size() != 0 &&
                        ...
                        Toast.makeText(MainActivity.this, "no data available 4", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(MainActivity.this, "no data available 5 ", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<PopularMain> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(MainActivity.this, "no data available 6", Toast.LENGTH_SHORT).show();
            }
        });
    }
